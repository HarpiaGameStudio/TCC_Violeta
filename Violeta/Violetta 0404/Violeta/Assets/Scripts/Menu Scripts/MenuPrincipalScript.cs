...
public class MenuPrincipalScript : MonoBehaviour {
	...
	private void Opcoes(bool ativarOP){
        ...
        if (ativarOP)
            myEventSystem.GetComponent<UnityEngine.EventSystems.EventSystem>().SetSelectedGameObject(Resolucoes.gameObject);
        else
            myEventSystem.GetComponent<UnityEngine.EventSystems.EventSystem>().SetSelectedGameObject(BotaoJogar.gameObject);
